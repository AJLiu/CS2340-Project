...
public class HistoricalReportAverageTest {
    ...
    HistoricalReportCal historicalReportCalc1; 
    HistoricalReportCal historicalReportCalc2; 
    ...
    public void setup() {
        ...
        test2 = new PurityReport(82.0, 90.0, 2, "Vinny", new Date().getTime(), PurityReport.OverallCondition.TREATEABLE, 300, 75);
        test3 = new PurityReport(82.0, 90.0, 2, "Shreya", new Date(2017, 1, 16), PurityReport.OverallCondition.TREATEABLE, 100, 200);
        testList = new ArrayList<>(); 
        testList[0] = test1;
        testList[1] = test2; 
        testList[2] = test3; 
        historicalReportCalc1 = new HistoricalReportCal(82.0, 90.0, 2017, "Virus");
        historicalReportCalc2 = new HistoricalReportCal(82.0, 90.0, 2017, "Contaminant")
