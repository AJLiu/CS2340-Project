...
public class SubmitPurityReportAPI extends AsyncTask<Void, Void, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        URL url = null;
        try {
            url = new URL(context.getString(R.string.apiHttpPath) + "/api/reports/purity/submit");
        ...
        try {
            ...
            System.out.println("Error inserting overall condition into main JSON");
            e.printStackTrace();
        }

        try {
            jsonObjToSend.put("virusPPM", Integer.parseInt(data.get("virusPPM")));
            jsonObjToSend.put("contaminantPPM", Integer.parseInt(data.get("contaminantPPM")));
        } catch (JSONException e) {
            e.printStackTrace();
        }
